...
public class CheckPermissionTest {
    ...
    @Test(expected = EventException.class)
    public void checkDeleteEventAdmTest() throws EventException, UserException {
        Participant author = new Participant(userInSessionSup, null, null, null);
        author.setAsAuthor();

        List<Participant> participantList = new ArrayList<>();
        participantList.add(author);
